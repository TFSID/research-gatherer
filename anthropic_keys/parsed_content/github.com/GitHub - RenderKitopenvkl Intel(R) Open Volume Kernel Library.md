---
source: https://github.com/RenderKit/openvkl
parsed_date: 2026-06-27 01:30:40
domain: github.com
---

Title: GitHub - RenderKit/openvkl: Intel(R) Open Volume Kernel Library

URL Source: https://github.com/RenderKit/openvkl

Markdown Content:
This is release v2.0.2 of Intel® Open VKL. For changes and new features see the [changelog](https://github.com/RenderKit/openvkl/blob/devel/CHANGELOG.md). Visit [http://www.openvkl.org](http://www.openvkl.org/) for more information.

## Overview

[](https://github.com/RenderKit/openvkl#overview)
...
Open VKL contains kernels optimized for the latest x86 processors with support for SSE, AVX, AVX2, and AVX-512 instructions, and for ARM processors with support for NEON instructions. Open VKL supports Intel GPUs based on the Xe HPG microarchitecture (Intel® Arc™ GPU) under Linux and Windows and Xe HPC microarchitecture (Intel® Data Center GPU Flex Series and Intel® Data Center GPU Max Series) under Linux. Intel GPU support leverages the [SYCL](https://www.khronos.org/sycl/) open standard programming language; SYCL allows one to write C++ code that can be run on various devices, such as CPUs and GPUs. Open VKL is part of the [Intel® oneAPI Rendering Toolkit](https://software.intel.com/en-us/rendering-framework) and is released under the permissive [Apache 2.0 license](http://www.apache.org/licenses/LICENSE-2.0).
...
[](https://github.com/RenderKit/openvkl#version-history)
### Open VKL 2.0.2

[](https://github.com/RenderKit/openvkl#open-vkl-202)
...
[](https://github.com/RenderKit/openvkl#open-vkl-201)
...
[](https://github.com/RenderKit/openvkl#open-vkl-200)
...
[](https://github.com/RenderKit/openvkl#open-vkl-132)
...
[](https://github.com/RenderKit/openvkl#open-vkl-131)
*   Superbuild updates to latest versions of dependencies
*   Note that the update to zlib v1.2.13 remedies CVE-2022-37434

### Open VKL 1.3.0

[](https://github.com/RenderKit/openvkl#open-vkl-130)
...
[](https://github.com/RenderKit/openvkl#open-vkl-120)
...
[](https://github.com/RenderKit/openvkl#open-vkl-110)
...
[](https://github.com/RenderKit/openvkl#open-vkl-101)
...
[](https://github.com/RenderKit/openvkl#open-vkl-100)
...
[](https://github.com/RenderKit/openvkl#open-vkl-0130)
...
[](https://github.com/RenderKit/openvkl#open-vkl-0121)
...
[](https://github.com/RenderKit/openvkl#open-vkl-0120)
...
[](https://github.com/RenderKit/openvkl#open-vkl-0110)
...
[](https://github.com/RenderKit/openvkl#open-vkl-0100-alpha)
...
[](https://github.com/RenderKit/openvkl#open-vkl-090-alpha)
...
[](https://github.com/RenderKit/openvkl#open-vkl-080-alpha)
...
[](https://github.com/RenderKit/openvkl#open-vkl-070-alpha)
*   Initial public alpha release, with support for structured, unstructured, and AMR volumes.

## Support and Contact

[](https://github.com/RenderKit/openvkl#support-and-contact)
Open VKL is under active development, and though we do our best to guarantee stable release versions a certain number of bugs, as-yet-missing features, inconsistencies, or any other issues are still possible. Should you find any such issues please report them immediately via [Open VKL’s GitHub Issue Tracker](https://github.com/OpenVKL/openvkl/issues) (or, if you should happen to have a fix for it, you can also send us a pull request); you may also contact us via email at [openvkl@googlegroups.com](mailto:openvkl@googlegroups.com).

Join our [mailing list](https://groups.google.com/forum/#!forum/openvkl-announce/join) to receive release announcements and major news regarding Open VKL.

## Open VKL API

[](https://github.com/RenderKit/openvkl#open-vkl-api)
...
[](https://github.com/RenderKit/openvkl#device-initialization-and-shutdown)
...
[](https://github.com/RenderKit/openvkl#environment-variables)
...
[](https://github.com/RenderKit/openvkl#error-handling-and-log-messages)
...
[](https://github.com/RenderKit/openvkl#basic-data-types)
...
[](https://github.com/RenderKit/openvkl#object-model)
...
Note that `mem` must always be a pointer _to_ the object, otherwise accidental type casting can occur. This is especially true for pointer types (`VKL_VOID_PTR` and `VKLObject` handles), as they will implicitly cast to `void\ *`, but be incorrectly interpreted.
...
[](https://github.com/RenderKit/openvkl#managed-data)
...
[](https://github.com/RenderKit/openvkl#volume-types)
...
[](https://github.com/RenderKit/openvkl#structured-volumes)
...
[](https://github.com/RenderKit/openvkl#structured-regular-volumes)
...
[](https://github.com/RenderKit/openvkl#reconstruction-filters)
...
[](https://github.com/RenderKit/openvkl#structured-spherical-volumes)
...
[![Image 1: Structured spherical volume coordinate system: radial distance ($r$), inclination angle ($\theta$), and azimuthal angle ($\phi$).](https://camo.githubusercontent.com/903928aa3abcc1f589551912295acaf0a583a8f752311e4c6f38cf06878ea8f7/68747470733a2f2f6f70656e766b6c2e6769746875622e696f2f696d616765732f737472756374757265645f73706865726963616c5f636f6f7264732e706e67)](https://camo.githubusercontent.com/903928aa3abcc1f589551912295acaf0a583a8f752311e4c6f38cf06878ea8f7/68747470733a2f2f6f70656e766b6c2e6769746875622e696f2f696d616765732f737472756374757265645f73706865726963616c5f636f6f7264732e706e67)
...
[](https://github.com/RenderKit/openvkl#adaptive-mesh-refinement-amr-volumes)
...
[](https://github.com/RenderKit/openvkl#unstructured-volumes)
...
[](https://github.com/RenderKit/openvkl#vdb-volumes)
...
[![Image 2: Structure of "vdb" volumes in the default configuration](https://camo.githubusercontent.com/4436529018a78ff37087c57479d6ed3b57b8b2ef49969a0c609c1c92b643302f/68747470733a2f2f6f70656e766b6c2e6769746875622e696f2f696d616765732f7664625f7374727563747572652e706e67)](https://camo.githubusercontent.com/4436529018a78ff37087c57479d6ed3b57b8b2ef49969a0c609c1c92b643302f/68747470733a2f2f6f70656e766b6c2e6769746875622e696f2f696d616765732f7664625f7374727563747572652e706e67)
...
[](https://github.com/RenderKit/openvkl#reconstruction-filters-1)
...
[](https://github.com/RenderKit/openvkl#major-differences-to-openvdb)
...
[](https://github.com/RenderKit/openvkl#loading-openvdb-vdb-files)
...
[](https://github.com/RenderKit/openvkl#particle-volumes)
...
[](https://github.com/RenderKit/openvkl#temporal-variation)
...
[](https://github.com/RenderKit/openvkl#sampler-objects)
...
[](https://github.com/RenderKit/openvkl#sampling)
...
[](https://github.com/RenderKit/openvkl#vector-wide-and-stream-wide-sampling-cpu-device-only)
...
[](https://github.com/RenderKit/openvkl#sampling-multiple-attributes)
...
[](https://github.com/RenderKit/openvkl#vector-wide-and-stream-wide-multi-attribute-sampling-cpu-device-only)
On the `cpu` device, vector-wide and stream-wide sampling APIs are also provided.
...
[](https://github.com/RenderKit/openvkl#gradients)
...
[](https://github.com/RenderKit/openvkl#vector-wide-and-stream-wide-gradients-cpu-device-only)
...
[](https://github.com/RenderKit/openvkl#iterators)
...
[](https://github.com/RenderKit/openvkl#observers)
...
[](https://github.com/RenderKit/openvkl#performance-recommendations)
## Feature flag usage on GPU

[](https://github.com/RenderKit/openvkl#feature-flag-usage-on-gpu)
...
[](https://github.com/RenderKit/openvkl#mxcsr-control-and-status-register)
...
[](https://github.com/RenderKit/openvkl#iterator-allocation)
...
[](https://github.com/RenderKit/openvkl#multi-attribute-volume-data-layout)
...
[](https://github.com/RenderKit/openvkl#examples)
...
[](https://github.com/RenderKit/openvkl#tutorials)
Simple tutorials can be found in the [`examples/`](https://github.com/openvkl/openvkl/tree/master/examples) directory. These are:
...
*   [`vklTutorialISPC.cpp`](https://github.com/openvkl/openvkl/blob/master/examples/ispc/vklTutorialISPC.cpp) and [`vklTutorialISPC.ispc`](https://github.com/openvkl/openvkl/blob/master/examples/ispc/vklTutorialISPC.ispc) : combined usage of the C and ISPC APIs with a CPU device
...
[](https://github.com/RenderKit/openvkl#interactive-examples)
Open VKL also ships with interactive example applications, [`vklExamples[CPU,GPU]`](https://github.com/openvkl/openvkl/blob/master/examples/interactive/vklExamples.cpp). The interactive viewer demonstrates multiple example renderers including a path tracer, isosurface renderer (using hit iterators), and ray marcher. The viewer UI supports switching between renderers interactively.

For CPU, each renderer has both a C++ and ISPC implementation showing recommended API usage. These implementations are available in the [`examples/interactive/renderer/`](https://github.com/openvkl/openvkl/tree/master/examples/interactive/renderer) directory. On GPU, the example renderers are written in SYCL.

[![Image 3: vklExamples interactive example application](https://camo.githubusercontent.com/84c76b504e577976b73326c3bea1a816caae1e2e5ad0af2561104587322b4fbd/68747470733a2f2f6f70656e766b6c2e6769746875622e696f2f696d616765732f766b6c4578616d706c65732e706e67)](https://camo.githubusercontent.com/84c76b504e577976b73326c3bea1a816caae1e2e5ad0af2561104587322b4fbd/68747470733a2f2f6f70656e766b6c2e6769746875622e696f2f696d616765732f766b6c4578616d706c65732e706e67)

## vklTutorial source

[](https://github.com/RenderKit/openvkl#vkltutorial-source)
For quick reference, the contents of [`vklTutorialCPU.c`](https://github.com/openvkl/openvkl/blob/master/examples/vklTutorialCPU.c) are shown below.
...
[](https://github.com/RenderKit/openvkl#packages)
Precompiled Open VKL packages for Linux, macOS, and Windows are available via [Open VKL GitHub releases](https://github.com/openvkl/openvkl/releases). Packages with “sycl” in the name include support for both x86 CPUs and Intel® GPUs, while the other packages only include x86 CPU support. Open VKL can be compiled from source (needed for ARM platforms) following the compilation instructions below.

## GPU Runtime Requirements

[](https://github.com/RenderKit/openvkl#gpu-runtime-requirements)
To run Open VKL on Intel® GPUs you will need to first have drivers installed on your system.

### GPU drivers on Linux

[](https://github.com/RenderKit/openvkl#gpu-drivers-on-linux)
Install the latest GPGPU drivers for your Intel® GPU from: [https://dgpu-docs.intel.com/](https://dgpu-docs.intel.com/). Follow the driver installation instructions for your graphics card.

### GPU drivers on Windows

[](https://github.com/RenderKit/openvkl#gpu-drivers-on-windows)
Install the latest GPGPU drivers for your Intel® GPU from: [https://www.intel.com/content/www/us/en/download/785597/intel-arc-iris-xe-graphics-windows.html](https://www.intel.com/content/www/us/en/download/785597/intel-arc-iris-xe-graphics-windows.html). Follow the driver installation instructions for your graphics card.

## Building Open VKL from source

[](https://github.com/RenderKit/openvkl#building-open-vkl-from-source)
The latest Open VKL sources are always available at the [Open VKL GitHub repository](http://github.com/OpenVKL/openvkl). The default `master` branch should always point to the latest tested bugfix release.

## Prerequisites

[](https://github.com/RenderKit/openvkl#prerequisites)
...
``` 
*   To build Open VKL you need [CMake](http://www.cmake.org/) version 3.10 or higher, any form of C++11 compiler (we recommend using GCC, but also support Clang and MSVC), and standard Linux development tools. To build the examples, you should also have some version of OpenGL.

*   Additionally you require a copy of the [Intel® Implicit SPMD Program Compiler (Intel® ISPC)](http://ispc.github.io/), version 1.18.0 or later. Please obtain a release of ISPC from the [ISPC downloads page](https://ispc.github.io/downloads.html).

*   Open VKL depends on the Intel RenderKit common library, rkcommon. rkcommon is available at the [rkcommon GitHub repository](https://github.com/ospray/rkcommon).

*   Open VKL depends on Embree, which is available at the [Embree GitHub repository](https://github.com/embree/embree).
...
[](https://github.com/RenderKit/openvkl#gpu-specific-prerequisites)
...
*   Download the [oneAPI DPC++ Compiler 2023-10-26](https://github.com/intel/llvm/releases/tag/nightly-2023-10-26); please note this specific version has been validated and used in our releases.
...
[](https://github.com/RenderKit/openvkl#cmake-superbuild)
...
[](https://github.com/RenderKit/openvkl#standard-cmake-build)
...
[](https://github.com/RenderKit/openvkl#projects-that-make-use-of-open-vkl)
...
[](https://github.com/RenderKit/openvkl#projects-that-are-closely-related-to-open-vkl)
