...
parsed_date: 2026-06-27 01:31:03
domain: github.com
---

Title: GitHub - RichardAtCT/claude-code-telegram: A powerful Telegram bot that provides remote access to Claude Code, enabling developers to interact with their projects from anywhere with full AI assistance and session persistence.

URL Source: https://github.com/RichardAtCT/claude-code-telegram

Markdown Content:
[![Image 1: License: MIT](https://camo.githubusercontent.com/fdf2982b9f5d7489dcf44570e714e3a15fce6253e0cc6b5aa61a075aac2ff71b/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f4c6963656e73652d4d49542d79656c6c6f772e737667)](https://opensource.org/licenses/MIT)[![Image 2: Python 3.11+](https://camo.githubusercontent.com/36cf3d0f7992a33a063d3833577d62204f8934d82b69874c086390608db4947c/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f707974686f6e2d332e31312b2d626c75652e737667)](https://www.python.org/downloads/)
...
[](https://github.com/RichardAtCT/claude-code-telegram#what-is-this)
...
[](https://github.com/RichardAtCT/claude-code-telegram#quick-start)
### Demo

[](https://github.com/RichardAtCT/claude-code-telegram#demo)
...
[](https://github.com/RichardAtCT/claude-code-telegram#1-prerequisites)
...
[](https://github.com/RichardAtCT/claude-code-telegram#2-install)
Choose your preferred method:

#### Option A: Install from a release tag (Recommended)

[](https://github.com/RichardAtCT/claude-code-telegram#option-a-install-from-a-release-tag-recommended)
...
[](https://github.com/RichardAtCT/claude-code-telegram#option-b-from-source-for-development)
...
[](https://github.com/RichardAtCT/claude-code-telegram#3-configure)
...
[](https://github.com/RichardAtCT/claude-code-telegram#4-run)
...
> **Detailed setup:** See [docs/setup.md](https://github.com/RichardAtCT/claude-code-telegram/blob/main/docs/setup.md) for Claude authentication options and troubleshooting.

## Modes

[](https://github.com/RichardAtCT/claude-code-telegram#modes)
The bot supports two interaction modes:

### Agentic Mode (Default)

[](https://github.com/RichardAtCT/claude-code-telegram#agentic-mode-default)
The default conversational mode. Just talk to Claude naturally -- no special commands required.

**Commands:**`/start`, `/new`, `/status`, `/verbose`, `/repo` If `ENABLE_PROJECT_THREADS=true`: `/sync_threads`
...
[](https://github.com/RichardAtCT/claude-code-telegram#github-workflow)
...
[](https://github.com/RichardAtCT/claude-code-telegram#classic-mode)
...
[](https://github.com/RichardAtCT/claude-code-telegram#event-driven-automation)
...
Enable with `ENABLE_API_SERVER=true` and `ENABLE_SCHEDULER=true`. See [docs/setup.md](https://github.com/RichardAtCT/claude-code-telegram/blob/main/docs/setup.md) for configuration.

## Features

[](https://github.com/RichardAtCT/claude-code-telegram#features)
### Working Features

[](https://github.com/RichardAtCT/claude-code-telegram#working-features)
...
*   Voice message transcription (Mistral Voxtral / OpenAI Whisper / [local whisper.cpp](https://github.com/RichardAtCT/claude-code-telegram/blob/main/docs/local-whisper-cpp.md))
...
*   16 configurable tools with allowlist/disallowlist control (see [docs/tools.md](https://github.com/RichardAtCT/claude-code-telegram/blob/main/docs/tools.md))

### Planned Enhancements

[](https://github.com/RichardAtCT/claude-code-telegram#planned-enhancements)
*   Plugin system for third-party extensions

## Configuration

[](https://github.com/RichardAtCT/claude-code-telegram#configuration)
### Required

[](https://github.com/RichardAtCT/claude-code-telegram#required)
...
[](https://github.com/RichardAtCT/claude-code-telegram#common-options)
...
[](https://github.com/RichardAtCT/claude-code-telegram#agentic-platform)
...
[](https://github.com/RichardAtCT/claude-code-telegram#project-threads-mode)
...
In strict mode, only `/start` and `/sync_threads` work outside mapped project topics. In private mode, `/start` auto-syncs project topics for your private bot chat. To use topics with your bot, enable them in BotFather: `Bot Settings -> Threaded mode`.

> **Full reference:** See [docs/configuration.md](https://github.com/RichardAtCT/claude-code-telegram/blob/main/docs/configuration.md) and [`.env.example`](https://github.com/RichardAtCT/claude-code-telegram/blob/main/.env.example).

### Finding Your Telegram User ID

[](https://github.com/RichardAtCT/claude-code-telegram#finding-your-telegram-user-id)
Message [@userinfobot](https://t.me/userinfobot) on Telegram -- it will reply with your user ID number.

## Troubleshooting

[](https://github.com/RichardAtCT/claude-code-telegram#troubleshooting)
**Bot doesn't respond:**
...
*   Check `CLAUDE_ALLOWED_TOOLS` includes necessary tools (see [docs/tools.md](https://github.com/RichardAtCT/claude-code-telegram/blob/main/docs/tools.md) for the full reference)
...
[](https://github.com/RichardAtCT/claude-code-telegram#security)
...
See [SECURITY.md](https://github.com/RichardAtCT/claude-code-telegram/blob/main/SECURITY.md) for details.

## Development

[](https://github.com/RichardAtCT/claude-code-telegram#development)
...
> **Full documentation:** See the [docs index](https://github.com/RichardAtCT/claude-code-telegram/blob/main/docs/README.md) for all guides and references.

### Version Management

[](https://github.com/RichardAtCT/claude-code-telegram#version-management)
...
[](https://github.com/RichardAtCT/claude-code-telegram#contributing)
...
[](https://github.com/RichardAtCT/claude-code-telegram#license)
MIT License -- see [LICENSE](https://github.com/RichardAtCT/claude-code-telegram/blob/main/LICENSE).

## Star History

[](https://github.com/RichardAtCT/claude-code-telegram#star-history)
[![Image 3: Star History Chart](https://camo.githubusercontent.com/a6c523c8e71f3a513a3fdd6049700807fa3e34814f91126c18cc5fb2aeaecd52/68747470733a2f2f6170692e737461722d686973746f72792e636f6d2f7376673f7265706f733d52696368617264417443542f636c617564652d636f64652d74656c656772616d26747970653d44617465)](https://star-history.com/#RichardAtCT/claude-code-telegram&Date)

## Acknowledgments

[](https://github.com/RichardAtCT/claude-code-telegram#acknowledgments)
